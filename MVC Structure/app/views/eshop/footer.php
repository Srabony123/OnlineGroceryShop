	<footer id="footer"><!--Footer-->
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="address">
							...
							<p>8/A, Dhanmondi, Dhaka-Banglades</p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="footer-bottom">
			...
			<div class="row">
            <p class="pull-left">
              Copyright © 2021 AyatMart Inc. All rights reserved.
            </p>
            <p class="pull-right">
              Designed by
              <span
                ><a target="_blank" href="https://www.facebook.com/mehedi1621"
                  >Mehedi Hasan</a
                ></span
              >
            </p>
